...
MACRO_TUNING_PARAM(HammerFireDelay, hammer_fire_delay, 50, "Delay of hammering (when hitting nothing)")
...
MACRO_TUNING_PARAM(HammerHitFireDelay, hammer_hit_fire_delay, 50, "Delay of hammering (when hitting another tee)")
