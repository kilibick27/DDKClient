...
// Suppress MSVC warning about <experimental/coroutine> pulled in transitively
// by some Windows SDK headers when building with C++20.
#ifndef _SILENCE_EXPERIMENTAL_COROUTINE_DEPRECATION_WARNING
#define _SILENCE_EXPERIMENTAL_COROUTINE_DEPRECATION_WARNING
#endif
...
#if defined(CONF_FAMILY_WINDOWS) && __has_include(<winrt/Windows.Media.Control.h>) && 0 // disabled: Windows SDK 10.0.19041 does not support C++20 WinRT
